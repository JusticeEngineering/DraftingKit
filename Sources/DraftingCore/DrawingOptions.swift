...
/// Knobs controlling classification, hidden-line handling, and sampling
/// resolution. The defaults suit CAD-clean meshes; for noisy scans raise
/// `creaseAngleDegrees` (45–60) and `epsilonFraction` (1e-5…1e-4).
