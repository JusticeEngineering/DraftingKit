// DraftingGraphics — CoreGraphics output: CGPath per kind and single-page
...
/// Styling and scale for `pdfData(style:)`. Stroke widths and dashes are
/// in PDF points on paper, independent of model scale.
public struct PDFStyle: Sendable {
    ...
    /// Creates a style; all other properties start at drafting defaults.
